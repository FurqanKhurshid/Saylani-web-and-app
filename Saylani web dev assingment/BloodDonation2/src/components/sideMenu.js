...
function SideMenu(props, { route, navigation }) {
    // console.log('routeSideMenu***',route,'navigation',navigation)

    console.log('data***', props.data)
    return (
        <View style={{ flex: 1, backgroundColor: '#bac0d1' }}>
            <DrawerContentScrollView {...props}>
                <View style={{ display: 'flex', alignItems: 'center', backgroundColor: '#b6c2d3' }}>
